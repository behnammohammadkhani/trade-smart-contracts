...
interface ERC20AuthorizableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20Authorizable extends Contract {
  ...
  interface: ERC20AuthorizableInterface;
