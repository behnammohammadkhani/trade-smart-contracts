...
interface PermissionItemsInterface extends ethers.utils.Interface {
  functions: {
...
export class PermissionItems extends Contract {
  ...
  interface: PermissionItemsInterface;
  ...
  callStatic: {
    ...
    setAdmin(account: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    revokeAdmin(account: string, overrides?: Overrides): Promise<BigNumber>;
